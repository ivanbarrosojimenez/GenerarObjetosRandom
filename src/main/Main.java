...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		UpdateMemberOrganizationRequest bean3 = objectFiller.createAndFill(UpdateMemberOrganizationRequest.class, 2,
				false);
		System.out.println("\n\n" + bean3.toString());

		OrganizationMemberToolsResponse bean4 = objectFiller.createAndFill(OrganizationMemberToolsResponse.class, 4,
				false);
		System.out.println("\n\n" + bean4.toString());
		
		OrganizationMemberToolsResponse bean5 = objectFiller.createAndFill(OrganizationMemberToolsResponse.class, 3,
				true);
		System.out.println("\n\n" + bean5.toString());
